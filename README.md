...
[![npm version](https://img.shields.io/npm/v/jslade.svg)](https://www.npmjs.com/package/jslade) [![tests](https://github.com/dottwatson/jslade/actions/workflows/test.yml/badge.svg)](https://github.com/dottwatson/jslade/actions/workflows/test.yml) [![coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/dottwatson/jslade/main/badges/coverage.json)](https://github.com/dottwatson/jslade/actions/workflows/test.yml) [![license](https://img.shields.io/npm/l/jslade.svg)](LICENSE.md)
...
- **Lazy assets** — `this.loadResources()` pulls JS/CSS when an island mounts; the same URL is loaded once.
