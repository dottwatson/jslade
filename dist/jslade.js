...
${def.markup || ''}
    ...
    var TYPES = { script: true, module: true, style: true }
    ...
    function readGlobal(win, name) {
        if (!win || name == null) return void 0
        return win[name]
    }
    ...
    function createLoadResources(options) {
        ...
        function loadResources2(input) {
            ...
            return list
                ...
                .then(function () {
                    return { entries, global: globalMap }
                })
        }
        return {
    ...
    var defaultLoader = createLoadResources()
    function loadResources(entries) {
